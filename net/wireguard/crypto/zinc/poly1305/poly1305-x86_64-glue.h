 ...
 * proceeding. The partial carry in this holds for limbs up to 2^27-1, which is
 * the bounds presumed by the author of the assembly, but just in case this
 * doesn't hold, we do a final reduction in case the limbs are up to 2^32-2^6-1.
 */
