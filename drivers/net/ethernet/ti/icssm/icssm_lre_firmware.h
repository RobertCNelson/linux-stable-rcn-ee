...
/* Increasing the STATS DMEM size for new stats */
...
#define ICSS_LRE_NODE_TABLE_FULL		(ICSS_LRE_START + 112)
#define ICSS_LRE_CNT_TX_CB	\
				(ICSS_LRE_START + ICSS_LRE_STATS_DMEM_SIZE)
#define ICSS_LRE_CNT_UNIQUE_RX_CB	\
				(ICSS_LRE_CNT_TX_CB + 4)
#define ICSS_LRE_CNT_DUPLICATE_RX_CB	\
				(ICSS_LRE_CNT_UNIQUE_RX_CB + 4)
#define ICSS_LRE_MULTICAST_DROPPED_B	\
				(ICSS_LRE_CNT_DUPLICATE_RX_CB + 4)
#define ICSS_LRE_VLAN_DROPPED_B		\
				(ICSS_LRE_MULTICAST_DROPPED_B + 4)
...
#define ICSS_LRE_NUM_STATS			43
#define ICSS_LRE_NUM_STANDARD_STATS		43
